...
clear
echo "////////////////////////"
echo "// meshpi Mesh Point"
echo "// ~~~~~~~~~~~~~~~~~~~~"
echo ""

read -p "This installation script will add a mesh point to your meshpi set up. It is assumed that you have already installed a meshpi access point and now wish to add a mesh point. Make sure you plugged a second wireless radio into your Raspberry Pi. Press any key to continue..."
echo ""
clear
...
EOF
	...
	# if no mesh point is created, set up network interfaces, hostapd and dnsmasq to operate without a bridge
		...
		# configure dnsmasq
		echo -en "Oops, did you set the DO_SET_MESH flag to 'y' in meshpi.config?"
		exit 0;
	;;
esac
