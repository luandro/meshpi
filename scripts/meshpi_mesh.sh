#!/bin/bash
# /etc/init.d/meshpi_mesh
# starts up mesh0, bat0 interfaces

### BEGIN INIT INFO
# Provides:          meshpi_mesh
# Required-Start:    dbus meshpi_ap
# Required-Stop:     dbus meshpi_ap
# Should-Start:	     $syslog
# Should-Stop:       $syslog
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: meshpi MESH
# Description:       meshpi MESH script
### END INIT INFO
